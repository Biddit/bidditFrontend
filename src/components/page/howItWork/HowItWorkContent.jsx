...
import work1 from "../../../assets/images/bg/how-work1.png";
import work2 from "../../../assets/images/bg/how-work2.png";
import work3 from "../../../assets/images/bg/how-work3.png";
          ...
          <div className="row g-4 mb-60">
            <div className="col-xl-6 col-lg-6">
              ...
              >
                ...
                <Link
                  to="/signup"
                  onClick={scrollTop}
                  className="eg-btn bg-[#210D42] text-white btn--md"
                >
                  Register Account
                </Link>
              </div>
            ...
            <div className="col-xl-6 col-lg-6 d-flex justify-content-lg-end justify-content-center">
              <div
                ...
                data-wow-delay=".2s"
              >
                <img alt="images" src={work1} className="work-img" />
              </div>
            </div>
          </div>
          <div className="row g-4 mb-60">
            ...
            <div className="col-xl-6 col-lg-6 order-lg-2 order-1">
              ...
              >
                ...
                <Link
                  ...
                  onClick={scrollTop}
                  className="eg-btn text-white  bg-[#210D42] btn--md"
                >
                  Add Your Item
                </Link>
              </div>
