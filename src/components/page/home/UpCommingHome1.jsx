                  ...
                  >
                    <div className="auction-img">
                      <img
                        alt="images"
                        src={
                          process.env.PUBLIC_URL + "/images/bg/umcoming1.png"
                        }
                      />
                      <div
                        className="auction-timer2 gap-lg-3 gap-md-2 gap-1"
                        id="timer7"
                      >
                        <TimeCounter />
                      </div>
                        ...
                        <div className="author-emo">
                          <img
                            ...
                            src={
                              ...
                              "/images/bg/upcoming-author1.png"
                            }
                          />
                        </div>
                      </div>
                  ...
                  >
                    <div className="auction-img">
                      <img
                        alt="images"
                        src={
                          process.env.PUBLIC_URL + "/images/bg/umcoming2.png"
                        }
                      />
                      <div
                        className="auction-timer2 gap-lg-3 gap-md-2 gap-1"
                      ...
                      <div className="author-area2">
                        ...
                        <div className="author-emo">
                          <img
                            ...
                            src={
                              process.env.PUBLIC_URL +
                              "/images/bg/upcoming-author2.png"
                            }
                          />
                        </div>
                      </div>
                    ...
                    <div className="c-feature-content">
                      ...
                      >
                        <h4>
                          Watercolor Special Lighter 2.2 For Saleing Offer
                        </h4>
                      </Link>
                      <p>
                        Bidding Price : <span>$15.99</span>
                  ...
                  >
                    <div className="auction-img">
                      <img
                        alt="images"
                        src={
                          process.env.PUBLIC_URL + "/images/bg/umcoming3.png"
                        }
                      />
                      <div
                        className="auction-timer2 gap-lg-3 gap-md-2 gap-1"
                      ...
                      <div className="author-area2">
                        ...
                        <div className="author-emo">
                          <img
                            ...
                            src={
                              process.env.PUBLIC_URL +
                              "/images/bg/upcoming-author3.png"
                            }
                          />
                        </div>
                      </div>
