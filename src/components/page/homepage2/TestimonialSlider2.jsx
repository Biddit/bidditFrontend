  ...
  return (
    <>
      <div className="testimonial-section pt-80 pb-80">
        ...
        <img
          alt="testimonialImage"
          src={process.env.PUBLIC_URL + "/images/bg/client-circle4.png"}
          className="client-circle4"
        />
        <img
          alt="testimonialImage"
          src={process.env.PUBLIC_URL + "/images/bg/client-circle5.png"}
        ...
        <div className="container">
          ...
          <div className="row justify-content-center position-relative">
            ...
            >
              <div className="swiper-wrapper">
                <SwiperSlide className="swiper-slide">
                  <div
                    className="testimonial-single style2 hover-border2 wow fadeInDown"
                  ...
                  >
                    <img
                      alt="testimonialImage"
                      src={
                        process.env.PUBLIC_URL + "/images/icons/quote-red.svg"
                      }
                    ...
                    <div className="testi-img">
                      <img
                        alt="testimonialImage"
                        src={process.env.PUBLIC_URL + "/images/bg/testi1.png"}
                      />
                    </div>
                ...
                <SwiperSlide className="swiper-slide">
                  ...
                  >
                    ...
                    <div className="testi-img">
                      <img
                        alt="testimonialImage"
                        src={process.env.PUBLIC_URL + "/images/bg/testi2.png"}
                      />
                    </div>
                    <div className="testi-content">
                      <div className="testi-designation">
                ...
                <SwiperSlide className="swiper-slide">
                  ...
                  >
                    ...
                    <div className="testi-img">
                      <img
                        alt="testimonialImage"
                        src={process.env.PUBLIC_URL + "/images/bg/testi3.png"}
                      />
                    </div>
                    <div className="testi-content">
                      <div className="testi-designation">
            ...
            <div className="slider-arrows testimonial2-arrow d-flex justify-content-between gap-3">
              <div
                className="testi-prev2 style-2 swiper-prev-arrow"
                tabIndex={0}
                role="button"
              ...
              <div
                className="testi-next2 style-2 swiper-next-arrow"
                tabIndex={0}
                role="button"
