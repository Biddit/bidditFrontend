                  ...
                  >
                    ...
                    <div className="auction-img">
                      <img
                        alt="images"
                        src={
                          process.env.PUBLIC_URL + "/images/bg/upcoming21.png"
                        }
                      />
                    ...
                    <div className="auction-content">
                      <h4>
                        <Link
                          ...
                          onClick={scrollTop}
                        >
                          Creative Fashion Ribbon Digital Watch Little
                        </Link>
                      </h4>
                      <p>
                  ...
                  >
                    <div className="auction-timer">
                      ...
                      <div className="countdown" id="timer8">
                        <h4>
                          <span id="days8">05</span>D :
                          <span id="hours8">05</span>H :{" "}
                          <span id="minutes8">52</span>M :{" "}
                          <span id="seconds8">32</span>S
                        </h4>
                      </div>
                    </div>
                    <div className="auction-img">
                      <img
                        alt="images"
                        src={
                          process.env.PUBLIC_URL + "/images/bg/upcoming22.png"
                        }
                      />
                      <div className="author-area">
                        <div className="author-emo">
                    ...
                    <div className="auction-content">
                      <h4>
                        <Link
                          ...
                          onClick={scrollTop}
                        >
                          Havit HV-GB62 USb Black Double Game Pad With
                        </Link>
                      </h4>
                      <p>
                        Bidding Price : <span>$85.9</span>
                  ...
                  >
                    <div className="auction-timer">
                      ...
                      <div className="countdown" id="timer9">
                        <h4>
                          <span id="days9">05</span>D :
                          <span id="hours9">05</span>H :{" "}
                          <span id="minutes9">52</span>M :{" "}
                          <span id="seconds9">32</span>S
                        </h4>
                      </div>
                    </div>
                    <div className="auction-img">
                      <img
                        alt="images"
                        src={
                          process.env.PUBLIC_URL + "/images/bg/upcoming23.png"
                        }
                      />
                      <div className="author-area">
                        <div className="author-emo">
                    ...
                    <div className="auction-content">
                      <h4>
                        <Link
                          ...
                          onClick={scrollTop}
                        >
                          Creative Fashion Riboon Digital Head Phone
                        </Link>
                      </h4>
                      <p>
                        Bidding Price : <span>$85.9</span>
