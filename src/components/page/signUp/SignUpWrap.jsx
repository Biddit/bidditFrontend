...
const SignUpWrap = () => {
  return (
    <div className="sm:ml-24 bg-white mr-4 rounded-2xl mb-[5rem] mt-[10rem] pt-4 px-16 h-[90vh] shadow-2xl  lg:w-1/2 ">
      <h1 className="py-10 text-3xl font-semibold text-[#f57d1f]">Register</h1>
        ...
        <form>
          ...
          <div className="flex py-4">
            ...
            <p>
              ...
              <b className="text-sm">Terms, Privacy Policy</b> <span> and</span>{" "}
              <b className="text-sm">Fees</b>.
            </p>
          </div>
          ...
          <p className="text-gray-300 py-2">
            ...
            <Link to='/login'>
              <span className="font-bold text-[#000] text-sm"> Login.</span>
            </Link>{" "}
          </p>
        </form>
      </div>
