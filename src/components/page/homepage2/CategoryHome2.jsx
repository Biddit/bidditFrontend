...
import category from "../../../assets/images/bg/cat-22.png";
import { Swiper, SwiperSlide } from "swiper/react";
import svg from "../../../assets/images/icons/cat-icon2.svg";
                ...
                <div className="swiper-wrapper">
                  ...
                  <SwiperSlide className="swiper-slide">
                    ...
                    >
                      <img
                        alt="categoryImage"
                        src={process.env.PUBLIC_URL + "/images/bg/cards.png"}
                        className="category-img"
                      />
                      <div className="content">
                        <img
                  ...
                  <SwiperSlide className="swiper-slide">
                    ...
                    >
                      <img
                        alt="categoryImage"
                        src={process.env.PUBLIC_URL + "/images/bg/fashion.png"}
                        className="category-img"
                      />
                      <div className="content">
                        <img
